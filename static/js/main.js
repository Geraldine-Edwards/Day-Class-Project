  ...
  let content = {
    home: `
            <div class="max-w-5xl mx-auto">
                <h1 class="text-3xl mb-4"> WELCOME TO <strong>You are not alone!</strong></h1>
                <p>Whether you’re facing food insecurity, housing issues, or financial hardship —<strong>you are not alone</strong>. </p>
                <p>Discover the support available near you.</p>
             </div>`,
    about: `
            <div class = "max-w-5xl mx-auto">
